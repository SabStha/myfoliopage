                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('admin.skills.store') }}" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input name="category" class="w-full rounded border-gray-300" />
                        </div>
                        <div>
                            <label class="block text-sm mb-1">Level</label>
                            <input name="level" class="w-full rounded border-gray-300" placeholder="Beginner / Intermediate / Advanced" />
                        </div>
