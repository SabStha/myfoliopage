<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('admin.skills.create') }}" class="px-3 py-2 text-sm rounded bg-blue-600 text-white">New Skill</a>
        </div>
    </x-slot>
    <div class="py-8">
                                ...
                                <tr class="border-b border-gray-100 dark:border-gray-700">
                                    ...
                                    <td class="py-2 text-right space-x-2">
                                        ...
                                        <form method="POST" action="{{ route('admin.skills.destroy', $skill) }}" class="inline">
                                            @csrf
                                            @method('DELETE')
                                            <button class="text-red-600 hover:underline" onclick="return confirm('Delete this skill?')">Delete</button>
                                        </form>
                                    </td>
                                </tr>
                            @empty
                                <tr><td class="py-4" colspan="4">No skills yet.</td></tr>
                            @endforelse
                        </tbody>
                    </table>
