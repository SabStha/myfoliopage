@extends('layouts.app')
@section('title', 'Create New Code Summary')
@section('content')
    <script>
                ...
                <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div x-show="previewData.title">
                            <h3 class="text-lg font-bold text-gray-900 mb-2" x-text="previewData.title || 'Code Summary Title'"></h3>
                        </div>
                        ...
                        <div x-show="previewData.code" class="bg-gray-900 rounded-lg overflow-hidden border-2 border-gray-800">
                            <div class="px-3 py-2 bg-gray-800 border-b border-gray-700 flex items-center gap-2">
                                ...
                                <span class="text-xs text-gray-400 ml-2" x-text="previewData.language || 'Code'"></span>
                            </div>
