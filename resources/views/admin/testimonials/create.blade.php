<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">{{ __('app.admin.testimonials.create_title') }}</h2>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">{{ __('app.admin.testimonials.create_description') }}</p>
            </div>
            ...
            <form method="POST" action="{{ route('admin.testimonials.store') }}" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            <x-dual-language-input 
                                name="quote" 
                                label="{{ __('app.admin.testimonials.testimonial_quote') }} *" 
                ...
                <div class="flex items-center justify-end gap-4 pt-6 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <button type="submit" class="inline-flex items-center gap-2 px-6 py-3 text-sm font-medium rounded-lg bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all shadow-sm hover:shadow-md">
                        ...
                        {{ __('app.admin.testimonials.create_testimonial_button') }}
                    </button>
                </div>
            </form>
        </div>
