...
class HeroSectionController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $data = $request->validate([
            ...
            'badge_size_mobile' => 'nullable|string|max:50',
            'badge_size_tablet' => 'nullable|string|max:50',
            'badge_size_desktop' => 'nullable|string|max:50',
            'badge_text_color' => 'nullable|string|max:7',
            ...
            'profile_images.*' => 'nullable|image|max:51200', // 50MB per image - allows very high quality images
        ...
        $heroSection->update([
            ...
            'badge_size_mobile' => $data['badge_size_mobile'] ?? $heroSection->badge_size_mobile ?? 'text-xs',
            'badge_size_tablet' => $data['badge_size_tablet'] ?? $heroSection->badge_size_tablet ?? 'text-sm',
            'badge_size_desktop' => $data['badge_size_desktop'] ?? $heroSection->badge_size_desktop ?? 'text-sm',
            'badge_text_color' => $data['badge_text_color'] ?? $heroSection->badge_text_color ?? '#000000',
    ...
    public function reset()
    {
        ...
        $heroSection->update([
            ...
            'badge_color' => '#ffb400',
            'badge_size_mobile' => 'text-xs',
            'badge_size_tablet' => 'text-sm',
            'badge_size_desktop' => 'text-sm',
