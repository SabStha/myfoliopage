...
Route::post('/api/locale/{locale}', [TranslationController::class, 'setLocale'])->name('api.locale.set');

Route::get('/api/translations/{locale}', [TranslationController::class, 'getTranslations'])->name('api.translations.get');
...
Route::get('/api/sections/{section}/content', [ContentApiController::class, 'getSectionContent'])->name('api.sections.content');
